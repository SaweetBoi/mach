const products = [
  {
    ...
    specs: [
      ...
      "Max Load: 15 Tons",
      "Fuel Capacity: 300L",
      "Hydraulic System: Advanced SmartFlow",
      "Operator Comfort: Ergonomic cabin with A/C",
      "Safety: 360° Cameras & Emergency Stop",
    ],
    brochure: "brochures/forklift.pdf"
  },
  {
    id: 2,
    name: "Bulldozer X2",
    ...
    specs: [
      ...
      "Track Width: 600mm",
      "Fuel Capacity: 450L",
      "Smart Diagnostics: AI-powered",
      "Cabin: Noise reduction & climate control",
    ],
    brochure: "brochures/bulldozer.pdf"
  },
  {
    id: 3,
    ...
    specs: [
      ...
      "Max Dig Depth: 8.5m",
      "Fuel Tank: 400L",
      "Smart Controls: AI-assisted digging",
      "Safety: Reinforced cabin & roll-over protection",
      "Efficiency: 20% fuel savings mode",
    ],
    brochure: "brochures/excavator.pdf"
  }
];
